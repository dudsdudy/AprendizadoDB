...
CONSTRAINT PK_Fornecedores_id PRIMARY KEY (id),
usar PRIMARY KEY ou CONSTRAINT
*/
...
ALTER TABLE Departamento ADD CONSTRAINT FK_Departamento_Funcionarios_Funcionarios_id FOREIGN KEY (idFuncionarios) REFERENCES Funcionarios(id);
...
CONCAT("empresa ", "endereco ","cidade ","cep " ,"pais") AS "Endereço Completo", 
f.telefone, 
c.nome_cat, 
c.descricao, 
c.imagem 
...
INSERT INTO Usuarios (idade, nome, situacao, idUsuarioDoador, idRaca) VALUES (7, 'Fluffy', 'castrado', 1,1);
INSERT INTO Usuarios (idade, nome, situacao, idUsuarioDoador, idRaca) VALUES (2, 'Mavis', 'não castrada', 1,1);

INSERT INTO Endereco (logradouro, numero, cidade, uf, idUsuario) VALUES ('Rua Botafogo', 44, 'Porto Alegre', 'RS', 1);
INSERT INTO Endereco (logradouro, numero, cidade, uf, idUsuario) VALUES ('Rua Alegrete', 17, 'Porto Alegre', 'RS', 2);


INSERT INTO Faturas (idade, nome, situacao, idUsuarioDoador, idRaca) VALUES (7, 'Fluffy', 'castrado', 1,1);
INSERT INTO Faturas (idade, nome, situacao, idUsuarioDoador, idRaca) VALUES (2, 'Mavis', 'não castrada', 1,1);

INSERT INTO Detalhes_Faturas (idade, nome, situacao, idUsuarioDoador, idRaca) VALUES (7, 'Fluffy', 'castrado', 1,1);
INSERT INTO Detalhes_Faturas (idade, nome, situacao, idUsuarioDoador, idRaca) VALUES (2, 'Mavis', 'não castrada', 1,1);

UPDATE Animal SET 
	dataAdocao = '2022-01-01',
	idUsuarioAdotante = 2
WHERE id = 1 ;
